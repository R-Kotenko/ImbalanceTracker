...
# 📈 ImbalanceTracker (укр версія)

### 🔍 Моніторинг дисбалансу в книзі замовлень Binance Spot(Top-10)

**ImbalanceTracker** — асинхронний трекер, який підключається до **Binance Spot WebSocket**, читає стакан (Top-10 bids/asks), рахує **imbalance_ratio** та генерує **алерти (тригери)** з логами й опційними Telegram-пушами.
